...
const samples = () => {
  return (
    <section className="mt-20">
      ...
      <div className="container mt-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-lg p-6 shadow-md flex flex-col justify-between transform transition-transform hover:scale-105">
          <div>
            <Image src="/product1.jpg.crdownload" alt="product" width={300} height={300} layout="responsive" className="object-cover" />
        ...
        <div className="bg-white rounded-lg p-6 shadow-md flex flex-col justify-between transform transition-transform hover:scale-105">
          <div>
            <Image src="/product3.jpg" alt="product" width={300} height={300} layout="responsive" className="object-cover" />
        ...
        <div className="bg-white rounded-lg p-6 shadow-md flex flex-col justify-between transform transition-transform hover:scale-105">
          <div>
            <Image src="/product4.jpg" alt="product" width={300} height={300} layout="responsive" className="object-cover" />
        ...
        <div className="bg-white rounded-lg p-6 shadow-md flex flex-col justify-between transform transition-transform hover:scale-105">
          <div>
            <Image src="/product7.jpg" alt="product" width={320} height={320} layout="responsive" className="object-cover" />
