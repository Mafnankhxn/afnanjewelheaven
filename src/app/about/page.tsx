      ...
      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/2 mb-6 md:mb-0">
          ...
          <p className="text-gray-600 leading-relaxed">
            Welcome to Jewelious, your source for exquisite and unique jewelry pieces. 
          ...
          <p className="text-gray-600 leading-relaxed mt-4">
            ...
            ensuring that every item you choose is a true work of art. Whether you are looking for a 
            special gift or a piece to complement your personal style, Jewelious has something 
