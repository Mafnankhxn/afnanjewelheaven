    ...
    <section className="bg-gray-100 py-16">
      <div className="container mx-auto">
        ...
        <p className="text-2xl font-semibold text-center text-gray-800 mt-12 leading-relaxed tracking-wide">
          Explore our catalogue to view our wide range of products. If you find something you are interested in, simply visit the contact page and get in touch with us to provide the details of the product.
        </p>
